...
const Profile = () => {
    ...
    useEffect(() => {
        getPostsFromUser(user.username)
    }, [user])
            ...
            <div className='bio'>
                ...
                <div className='right'>
                    ...
                    <div className='numbers'>
                        <span><strong>{user.countOfPosts}</strong> posts</span>
                        <span><strong>{user.countOfFollowers}</strong> followers</span>
                        <span><strong>{user.countOfFollowing}</strong> following</span>
                    </div>
                    <p className='name'>{user.firstName + ' ' + user.lastName}</p>
                    <div className='text'>{user.bio}</div>
